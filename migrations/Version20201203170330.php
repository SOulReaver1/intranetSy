 ...
 */
final class Version20201203170330 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer_files ADD installer VARCHAR(255) DEFAULT NULL, DROP installer_id');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE customer_files ADD installer_id INT DEFAULT NULL, DROP installer');
